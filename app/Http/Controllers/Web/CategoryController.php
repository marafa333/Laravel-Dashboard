    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('web.index')->with('success', 'Category created successfully.');
}
    ...
    public function update(Request $request, Category $category)
{
    ...
    return redirect()->route('web.index')->with('success', 'Category updated successfully.');
}
    ...
    public function destroy(Category $category)
    {
        ...
        return redirect()->route('web.index')->with('success', 'Category deleted successfully.');
    }
}